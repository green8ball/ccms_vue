        ...
        <div class="column is-4 is-offset-4">
          ...
          <div class="box">     
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <div class="field">
                <div class="control">
                  <input class="input is-large" type="text" placeholder="ezLM ID" v-model="user.ezLMID">
                </div>
              </div>  

              <div class="field">
                <div class="control">
                  <input class="input is-large" type="text" placeholder="AD ID" v-model="user.adid">
                </div>
              </div>
...
private handleSubmit() {
  this.isBusy = true;
  accountService.register(this.user).pipe(
